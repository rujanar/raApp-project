    ...
    <body>
		<div class="container">
                    ...
                    <div class="content">
                        ...
                        <h3>Pregled Vaših nezapočetih aktivnosti</h3>
                        </div>
				...
				<tr>
					...
					<th>Status</th>
                                ...
                                <c:forEach items="${trenutniZadaci}" var="zadatak">
                                    ...
                                    <c:forEach items="${aktivnosti}" var="aktivnost">
                                        <c:if test="${aktivnost.akt_zadatak_id==zadatak.zadatak_id}">
                                            <c:if test="${korisnik_id==aktivnost.akt_korisnik_id}">
                                            <c:if test="${aktivnost.status=='Nezapočeto'}">
                                            <% counter++;%>
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${aktivnost.akt_zadatak_id==zadatak.zadatak_id}">
                                            ...
                                            <td class="td-centar-zad">
                                                <ul>
                                                    <li class="action-li-utoku">
                                                        <a class="a-action-li-status" onclick="return confirm('Da li ste sigurni da želite da promenite status?')" href="Pregled?action=statusut&aktivnost_id=${aktivnost.aktivnost_id}">U toku</a>
                                                    </li>
                                                </ul>    
                                            </td>
                                    </tr>
                        ...
                        <c:if test="${empty trenutniZadaci}">
                            <h4>Nemate aktivnosti koje su nezapočete.</h4>
                        </c:if>
                        </div>
		</div>
	</div>	
